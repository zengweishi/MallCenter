...
public class ContentController {
    ...
    public Result<List<Content>> findContentByCategoryId(@PathVariable Long id) {
        List<Content> list = contentService.findByCategoryId(id);
        return new Result<List<Content>>(true,StatusCode.OK,"根据category分类ID查询content列表成功",list);
    }
}
